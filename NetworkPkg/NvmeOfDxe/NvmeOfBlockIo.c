  ...
  )
{
  ...
  DEBUG ((
    DEBUG_BLKIO,
    "NvmeOfRead: Lba = 0x%08Lx, Original = 0x%08Lx, "
  ...
  )
{
  ...
  DEBUG ((
    DEBUG_BLKIO,
    "NvmeOfAsyncRead: Lba = 0x%08Lx, Original = 0x%08Lx, "
    "Remaining = 0x%08Lx, BlockSize = 0x%x, Status = %r\n",
    Lba,
    (UINT64)OrginalBlocks,
    (UINT64)Blocks,
  ...
  )
{
  ...
  DEBUG ((
    DEBUG_BLKIO,
    "NvmeOfWrite: Lba = 0x%08Lx, Original = 0x%08Lx, "
    "Remaining = 0x%08Lx, BlockSize = 0x%x, Status = %r\n",
    Lba,
    (UINT64)OrginalBlocks,
    (UINT64)Blocks,
  ...
  )
{
  ...
  DEBUG ((
    DEBUG_BLKIO,
    "NvmeOfAsyncWrite: Lba = 0x%08Lx, Original = 0x%08Lx, "
    "Remaining = 0x%08Lx, BlockSize = 0x%x, Status = %r\n",
    Lba,
    (UINT64)OrginalBlocks,
    (UINT64)Blocks,
  ...
  )
{
  ...
  Status = spdk_nvme_ctrlr_security_receive (
             Device->NameSpace->ctrlr,
             SecurityProtocolId,
  ...
  )
{
  ...
  Status = spdk_nvme_ctrlr_security_send (
             Device->NameSpace->ctrlr,
             SecurityProtocolId,
             SecurityProtocolSpecificData,
             0xEA,
